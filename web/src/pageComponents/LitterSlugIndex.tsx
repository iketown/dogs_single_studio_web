...
const LitterSlugIndex = ({ layout_info, litter }) => {
  ...
  return (
    <Layout {...{ layout_info }}>
      ...
      {preSections && <div>{displaySections(preSections)}</div>}
      ...
      <div style={{ background: "var(--color-darkB)" }}>
        ...
        >
          ...
          >
            {litter.born_date && (
              <FaBirthdayCake size="2rem" color="lightgrey" className="mb-2" />
            )}
...
export default LitterSlugIndex;
